...
<body class="bg-gray-100 p-8">
    ...
    <a href="{{ route('locations.create') }}" class="mb-4 inline-block bg-green-500 text-white py-2 px-4 rounded">Create Location</a>
            ...
            @foreach($locations as $location)
                <tr>
                    ...
                    <td class="py-2 px-4 border-b">
                        <a href="{{ route('locations.edit', $location->id) }}" class="bg-yellow-500 text-white py-1 px-2 rounded">Edit</a>
    ...
    <form method="POST" action="{{ route('admin.logout') }}" class="mt-4">
        @csrf
        <button type="submit" class="bg-blue-500 text-white py-2 px-4 rounded hover:bg-blue-600">Logout</button>
    </form>
